    ...
    <div>
      ...
      <div className="relative -top-[210px] left-[75px] imgClass w-max">
        <AnimationOnScroll animateIn="animate__fadeInLeftBig">
          <h1 class="mb-3 font-[800] text-[65px] text-blue-300">
      ...
      <div className="flex flex-col ml-5">
        ...
        <div className="flex flex-row flex-wrap justify-center gap-20 max-w-full px-3">
          {data.map((res) => {
            return (
              <div className="w-[390px] transition duration-300 ease-in-out hover:scale-110">
                <Cards
                  header={res.header}
...
<div className="flex flex-col items-center">
      <div class="max-w-[700px] p-6 bg-white border border-gray-200 rounded-lg shadow mt-10 transition duration-300 ease-in-out hover:scale-110 shadow-lg">
        <a href="#">
          <h5 class="mb-2 text-[35px] font-bold tracking-tight text-blue-500">
        ...
        <a
          href="#"
          class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-orange-400 focus:ring-4 focus:outline-none focus:ring-blue-300 "
        >
          Get in Touch
          <svg
            aria-hidden="true"
