    ...
    <div className="flex flex-col justify-start gap-[50px] m-9">
      ...
      <div className="flex flex-row justify-start gap-[95px]">
        <div className="bg-slate-300 hover:bg-orange-300 p-4 rounded-xl">
          ...
          {hotels.map((val, i) => {
            return (
              <div className="flex flex-row flex-wrap justify-between pb-4 font-semibold pt-6">
                <div className="w-[150px] text-start">{val.name}</div>
                <div className="w-[150px] text-start">
                  {val.services.map((service) => {
                    return (
                      <p className="bg-slate-200 p-1 rounded-xl m-1">
                        #{service}
                      </p>
                    );
                  })}
        ...
        <div className="bg-slate-300 hover:bg-orange-300 p-4 rounded-xl mt-[56px] h-[423px]">
          ...
          {Travel.map((val, i) => {
            return (
              <div className="flex flex-row gap-[40px] flex-wrap justify-between p-4 font-semibold">
        ...
        <div className="bg-slate-300 hover:bg-orange-300 p-4 rounded-xl h-[290px] w-[338px] mt-[128px]">
          <div className="flex flex-col font-bold text-[20px] gap-[17px]">
            ...
            <div className=" text-center">
                <button onClick={()=>navigateTo('/thankyou')} type="button" class="rounded-full p-2 rounded-lg mt-[4px] text-white bg-blue-500">Make a trip </button>
            </div>
          ...
          return (
            <div className="flex flex-row justify-start gap-[30px]">
              ...
              >
                ...
                <div class="absolute left-[239px] py-3 top-0 inset-x-0 text-white">
                  <p className="mt-[20px] font-bold text-[20px] text-black w-fit">
                    Name: {val.name}
                  </p>
                </div>

                <div class="absolute left-[239px] py-3 top-[42px] inset-x-0 text-white">
                  <p className="mt-[20px] font-bold text-[20px] text-black w-fit">
                    Phone: {val.phone}
                  </p>
                </div>

                <div class="absolute left-[239px] py-3 top-[80px] inset-x-0 text-white">
                  <p className="mt-[20px] font-bold text-[20px] text-black w-fit">
                    Amount: {val.amount}
                  </p>
                </div>
                ...
                <div class="absolute left-[239px] py-3 top-[119px] inset-x-0 text-white">
                  <p className="mt-[20px] font-bold text-[20px] text-black w-fit">
                ...
                <div class="absolute left-[238px] py-3 top-[196px] inset-x-0 text-white">
                  <button
