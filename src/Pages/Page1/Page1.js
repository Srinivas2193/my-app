      ...
      {Items.page1Cards.map((val, i)=>{
        return(
          <div key={i} className="relative w-[448px] h-[622px] rounded-2xl shadow-lg cursor-pointer" onClick={()=>navigateTo('/destinations/detailpage',{state:val})}>
            ...
            <div class="absolute left-[167px] rounded-2xl bg-orange-300 w-[140px] py-3 bottom-[87px] inset-x-0 text-white text-lg font-bold text-center leading-4">
              <p>{val.amount}</p>
            </div>

            <div class="absolute left-[164px] py-3 bottom-[17px] inset-x-0 text-white">
